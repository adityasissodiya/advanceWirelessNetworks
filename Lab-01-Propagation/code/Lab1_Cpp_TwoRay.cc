/*
 * Lab 1 Starter: Two-Ray Ground Propagation Loss Model
 * Usage: ./waf --run "scratch/Lab1_Cpp_TwoRay --distance=X"
 */
...
int main(int argc, char *argv[])
{
    ...
    // WiFi channel with Two-Ray-Ground model
    ...
    // Mobility: place at (0,0) and (distance,0)
    ...
    // UDP OnOff application: node0 -> node1
    ...
    std::cout << "TwoRay throughput: " << throughput << " bps\n";
